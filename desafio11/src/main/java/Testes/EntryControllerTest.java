...
public class EntryControllerTest {
    ...
    public void testandoMetodoCreat() throws Exception {
        ...
        mockMvc.perform(post("/lancamentos").contentType(MediaType.APPLICATION_JSON));
        verifyNoMoreInteractions(entryService);
    }
    ...
    public void testandoMetodoUpdate() throws Exception {
        ...
        mockMvc.perform(put("/categorias", entry.getId()).contentType(MediaType.APPLICATION_JSON));
        verifyNoMoreInteractions(entryService);
    }
